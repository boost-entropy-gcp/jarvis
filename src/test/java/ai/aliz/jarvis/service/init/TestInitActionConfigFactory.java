...
public class TestInitActionConfigFactory {
    ...
    public void testGetInitActionConfigsSQLExecFromBQL() {
        ...
        List<InitActionConfig> actionConfigs = initActionConfigFactory.getInitActionConfigs(contextLoader, new HashMap<>(), new File("src/test/resources/init/bql"));
    ...
    public void testGetInitActionConfigsSQLExecFromSQL() {
        ...
        List<InitActionConfig> actionConfigs = initActionConfigFactory.getInitActionConfigs(contextLoader, new HashMap<>(), new File("src/test/resources/init/sql"));
    ...
    public void testGetInitActionConfigsBQLoadFromJSON() {
        ...
        List<InitActionConfig> actionConfigs = initActionConfigFactory.getInitActionConfigs(contextLoader, new HashMap<>(), new File("src/test/resources/init/bq"));
    ...
    public void testGetInitActionConfigsSFTP() {
        ...
        List<InitActionConfig> actionConfigs = initActionConfigFactory.getInitActionConfigs(contextLoader, new HashMap<>(), new File("src/test/resources/init/sftp"));
    ...
    public void testGetInitActionConfigsNotSupported() {
        ...
        initActionConfigFactory.getInitActionConfigs(contextLoader, new HashMap<>(), new File("src/test/resources/init/not-supported"));
    }
}
